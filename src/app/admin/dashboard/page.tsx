    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-2">Monitor your salon platform performance and activities</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{dashboardStats.totalSalons.toLocaleString()}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-600">{dashboardStats.activeSalons.toLocaleString()}</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Highest revenue generating salons this month</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                  ...
                  <div key={salon.id} className="flex items-center space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center space-x-4 mt-1">
                        <span className="text-xs text-gray-500">{salon.bookings} bookings</span>
                        <span className="text-xs font-medium text-green-600">${salon.revenue.toLocaleString()}</span>
                      </div>
                    </div>
                  </div>
                ))}
                ...
                <div key={service.name} className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-sm text-gray-500">{service.bookings.toLocaleString()} bookings</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div className="bg-purple-600 h-2 rounded-full" style={{ width: `${service.percentage}%` }}></div>
                    </div>
                    <div className="flex justify-between mt-1">
                      <span className="text-xs text-gray-500">{service.percentage}% of total bookings</span>
                    </div>
                  </div>
                </div>
              ))}
